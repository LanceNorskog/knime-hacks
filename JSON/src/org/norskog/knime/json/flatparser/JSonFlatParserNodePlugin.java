 ...
 * @author Norskog
 */
public class JSonFlatParserNodePlugin extends Plugin {
    // The shared instance.
    private static JSonFlatParserNodePlugin plugin;

    /**
     * The constructor.
     */
    public JSonFlatParserNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static JSonFlatParserNodePlugin getDefault() {
        return plugin;
    }
