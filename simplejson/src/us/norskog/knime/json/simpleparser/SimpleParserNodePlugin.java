 ...
 */
public class SimpleParserNodePlugin extends Plugin {
    // The shared instance.
    private static SimpleParserNodePlugin plugin;

    /**
     * The constructor.
     */
    public SimpleParserNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SimpleParserNodePlugin getDefault() {
        return plugin;
    }
